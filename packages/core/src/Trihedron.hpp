...
#ifndef Trihedron_HeaderFile
#define Trihedron_HeaderFile
...
class Trihedron : public Standard_Transient
{
public:
  //! Creates a default trihedron.
  Standard_EXPORT Trihedron();

  //! Destructor.
  Standard_EXPORT virtual ~Trihedron();
