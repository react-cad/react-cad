...
A triangular profile extruded along a series of straight lines. We extend the path in the negative y-direction, as this will equate to the positive z-direction, ie upwards.
