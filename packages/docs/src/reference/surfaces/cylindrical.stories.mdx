...
<Meta title="Reference/Surfaces & SVGs/Cylindrical surface" />
...
export const CylindricalSurface = (props) => <cylindricalSurface {...props} />;
...
<Source
  language="jsx"
  code={`<cylindricalSurface radius={20} origin={[0,0,-20]}>
